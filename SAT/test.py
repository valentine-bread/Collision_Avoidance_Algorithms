...
def run():
    ...
    while True:
        ...
        collide = sat.separating_axis_theorem(poly2, poly1)
        polygon(poly1)

        #collide1 = gjk.collidePolyCircle(poly2, circle1)
        #circle(circle1)
        
        collide2 = sat.separating_axis_theorem(circle2, poly2)
        circle(circle2)

        polygon(poly2, GREEN if  collide2 or collide else RED)
